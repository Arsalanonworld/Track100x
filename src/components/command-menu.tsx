  ...
  return (
    <>
      <Button
        variant="outline"
        className={cn(
          'relative h-9 w-full justify-start rounded-full bg-muted text-sm font-normal text-muted-foreground shadow-none sm:pr-12'
        )}
        onClick={() => setOpen(true)}
      >
        <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
        <span className="hidden lg:inline-flex pl-5">Search...</span>
        <span className="inline-flex lg:hidden pl-5">Search...</span>
