...
export const mockWhaleTxs: WhaleTransaction[] = [
  ...
  {
      id: '4',
      token: { symbol: 'WIF', icon: `https://assets.coingecko.com/coins/images/33566/large/dogwifhat.jpg` },
      value: '$11.8M',
  ...
  {
      id: '6',
      token: { symbol: 'BONK', icon: `https://assets.coingecko.com/coins/images/32982/large/bonk.jpg` },
      value: '$12.4M',
      from: '0xabcdef1234567890abcdef1234567890abcdef',
      fromShort: '0xabcd...cdef',
      fromTags: ['Whale'],
  ...
  {
      id: '8',
      token: { symbol: 'SHIB', icon: `https://assets.coingecko.com/coins/images/11939/large/shiba.png` },
      value: '$8.2M',
